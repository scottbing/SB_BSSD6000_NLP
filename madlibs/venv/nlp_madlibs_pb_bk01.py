...
#taken from Geeks for Geeks: https://www.geeksforgeeks.org/progressbar-widget-in-tkinter-python/
def progressBar():
...
#barVar = DoubleVar()
#barVar.set(0)
progress = Progressbar(originalframe, orient=HORIZONTAL, style='black.Horizontal.TProgressbar',
